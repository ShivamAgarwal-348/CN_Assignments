...
main (int argc, char *argv[])
{
  ...
  std::string bandwidth01 = "10Mbps";
  std::string bandwidth12 = "7Mbps";
  std::string delay01 = "100ms";
  ...
  pointToPoint.SetDeviceAttribute ("DataRate", StringValue (bandwidth01));
  pointToPoint.SetChannelAttribute ("Delay", StringValue (delay01));
  ...
  pointToPoint2.SetDeviceAttribute ("DataRate", StringValue (bandwidth12));
  pointToPoint2.SetChannelAttribute ("Delay", StringValue (delay12));
...
Ipv4AddressHelper address2;
  ...
  Ptr<OutputStreamWrapper> stream = asciiTraceHelper.CreateFileStream ("assignment3.cwnd");
  ns3TcpSocket->TraceConnectWithoutContext ("CongestionWindow", MakeBoundCallback (&CwndChange, stream));

  //detailed trace of queue enq/deq packet tx/rx
  AsciiTraceHelper ascii;
  pointToPoint.EnableAsciiAll (ascii.CreateFileStream ("assignment3.tr"));
  pointToPoint.EnablePcapAll ("assignment3");
